...
var InterpolateHtmlPlugin = require('@danproudfeet/react-dev-utils/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('@danproudfeet/react-dev-utils/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('@danproudfeet/react-dev-utils/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('@danproudfeet/react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('@danproudfeet/react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('@danproudfeet/react-dev-utils/eslintFormatter');
...
} = require('@danproudfeet/react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('@danproudfeet/react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('@danproudfeet/react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('@danproudfeet/react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('@danproudfeet/react-dev-utils/openBrowser');
